            ...
            <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md px-4 sm:px-0">
                <div class="bg-white py-8 px-6 shadow-sm sm:rounded-lg sm:px-10">
                    ...
                    <div class="mt-6">
                        ...
                        <!-- Google (KEPT) -->
                         <a href="./google/google-login.php" class="flex items-center justify-center gap-2 rounded-md border mt-1 py-2 text-sm font-medium hover:bg-gray-50 w-full transition">
